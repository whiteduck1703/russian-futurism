  ...
  const conflicts = [
    {
      ...
      context: 'Визит Маринетти в Петербург, январь 1914',
      quoteLeft: 'Русские &#x2013; псевдофутуристы. Их заумь &#x2013; это локальная версия моего слова на свободе, не более.',
      authorLeft: 'Маринетти',
      quoteRight: 'Заумь &#x2013; принципиально новое явление, не производное от итальянского образца. Русский футуризм обращён к мифу и архаике &#x2013; того, чего у Маринетти нет и быть не может.',
      authorRight: 'Лившиц',
    ...
    },
    {
      ...
      quoteLeft: 'Северянин превращает слово в драгоценность &#x2013; для нас это буржуазный эстетизм. Слово &#x2013; это не украшение, это взрывчатка.',
      authorLeft: 'Маяковский',
      quoteRight: 'Гилейцы &#x2013; варвары без образования. Я знаю традицию лучше вас и именно поэтому имею право с ней играть.',
      authorRight: 'Северянин',
    ...
    },
    {
      ...
      authorRight: 'Бобров',
      outcome: 'Итог: Пастернак и Маяковский сохранили личную дружбу &#x2013; взаимное притяжение двух принципиально разных художников',
