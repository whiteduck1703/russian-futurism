...
export function LanguageLab() {
  ...
  const tabs = [
    {
      title: 'КРУЧЕНЫХ &#x2013; ЗАУМЬ',
      author: 'Алексей Крученых, 1913',
      annotationTitle: 'Заумь: материал, а не язык',
      annotationText: 'Слово, освобождённое от смысла. Крученых утверждал, что в этом тексте «больше русского национального, чем во всей поэзии Пушкина» &#x2013; он апеллирует к дорефлексивным, звуковым пластам сознания. Для Крученых слово &#x2013; материал, который можно расплавить. Вопрос о том, является ли заумь разрушением языка или его первооснованием, остаётся открытым.'
    },
    {
      title: 'ХЛЕБНИКОВ &#x2013; КОРНЕСЛОВИЕ',
            ...
            {tabs.map((tab, index) => (
              ...
              >
                <div className="text-[20px] mb-3" style={{ fontFamily: 'var(--font-display)', fontWeight: 700, color: tabColors[index] }}>
                  {index === 0 ? 'КРУЧЕНЫХ' : index === 1 ? 'ХЛЕБНИКОВ' : 'МАЯКОВСКИЙ'}
                </div>
