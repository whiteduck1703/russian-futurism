...
const paintings = [
  {
    ...
    description: 'Малевич разбивает единое движение на серию моментов – как слово разбивается на звуки в зауми. В. Хлебников и А. Кручёных делали с языком то же самое. Картина написана в год, когда Малевич оформлял книги Гилеи.',
  },
  {
    ...
    description: 'Городское движение, скорость, механика – главные темы футуризма. Гончарова иллюстрировала книги А. Кручёных и была в орбите Гилеи. Множество наложенных кадров движения предвосхищают монтажное мышление кино.',
  },
  {
    title: 'Стекло',
  ...
  },
  {
    ...
    description: 'Авиатор – типичный герой футуризма: человек скорости, технологии, будущего. Тот же год, что Трагедия В. Маяковского. Фрагменты карт, игральных карт, газет – коллажная логика, родная и поэтам-гилейцам.',
  },
  {
    ...
    description: 'Алогизм в живописи – точный аналог алогизма в поэзии А. Кручёных. Малевич сталкивает несовместимые предметы по той же логике, по которой А. Кручёных сталкивал несовместимые слова. Дыр бул щыл и Корова и скрипка – одна стратегия.',
  },
  {
    title: 'Кубизм',
  ...
  },
  {
    ...
    description: 'Тема велосипедиста – классический сюжет футуризма: скорость, механика, ритм. Розанова разлагает движение на множество перекрывающихся моментов. Год спустя она создаст иллюстрации к Заумной книге А. Кручёных.',
  },
  {
    ...
    description: 'Радикальный жест обнуления – как Поэма конца В. Гнедова (1913): пустая страница как текст. Малевич и В. Гнедов независимо пришли к одному выводу: за пределом формы начинается подлинное. Кубофутуризм прошёл, супрематизм – следующий шаг.',
  },
  {
    ...
    description: 'Розанова – ближайший соавтор А. Кручёных: она создавала образы для его заумных книг. Переход от книжной графики к беспредметной живописи параллелен переходу А. Кручёных от кубофутуризма к зауми. Цвет освобождается от предмета – как звук освобождается от слова.',
  },
  {
  ...
  },
  {
    ...
    description: 'Попова переводит плоскости Малевича в архитектоническое мышление. Цвет и форма – строительные элементы, а не украшение. Она иллюстрировала книги А. Кручёных и входила в орбиту Гилеи: её путь от кубофутуризма к супрематизму – модель всего движения.',
  },
  {
    ...
    description: 'Форма растворяется в фоне. Предел редукции: молчание в живописи. Перекликается с Поэмой конца В. Гнедова – тишиной в поэзии. Оба произведения ставят один вопрос: что остаётся, когда убрано всё лишнее?',
  },
  {
    ...
    description: 'Лучизм – живописный аналог зауми: изображается не предмет, а лучи, исходящие от него. Восприятие важнее вещи. В тот же год А. Кручёных публикует Дыр бул щыл – звуки важнее слов. Обе стратегии атакуют одно и то же.',
  },
  {
  ...
  },
  {
    ...
    description: 'Лисицкий создал дизайн книги Для голоса (1923) по стихам В. Маяковского – один из главных памятников визуального авангарда. Конструктивизм наследует кубофутуризму: слово как форма, форма как действие.',
  },
  {
    title: 'Чёрное на чёрном',
