...
const paintings = [
  {
    ...
    description: 'Малевич разбивает единое движение на серию моментов – как слово разбивается на звуки в зауми. В. Хлебников и А. Крученых делали с языком то же самое. Картина написана в год, когда Малевич оформлял книги Гилеи.',
  },
  {
    ...
    description: 'Городское движение, скорость, механика – главные темы футуризма. Гончарова иллюстрировала книги А. Крученых и была в орбите Гилеи. Множество наложенных кадров движения предвосхищают монтажное мышление кино.',
  },
  {
    title: 'Стекло',
  ...
  },
  {
    ...
    description: 'Алогизм в живописи – точный аналог алогизма в поэзии А. Крученых. Малевич сталкивает несовместимые предметы по той же логике, по которой А. Крученых сталкивал несовместимые слова. Дыр бул щыл и Корова и скрипка – одна стратегия.',
  },
  {
    title: 'Кубизм',
  ...
  },
  {
    ...
    description: 'Тема велосипедиста – классический сюжет футуризма: скорость, механика, ритм. Розанова разлагает движение на множество перекрывающихся моментов. Год спустя она создаст иллюстрации к Заумной книге А. Крученых.',
  },
  {
  ...
  },
  {
    ...
    description: 'Розанова – ближайший соавтор А. Крученых: она создавала образы для его заумных книг. Переход от книжной графики к беспредметной живописи параллелен переходу А. Крученых от кубофутуризма к зауми. Цвет освобождается от предмета – как звук освобождается от слова.',
  },
  {
  ...
  },
  {
    ...
    description: 'Попова переводит плоскости Малевича в архитектоническое мышление. Цвет и форма – строительные элементы, а не украшение. Она иллюстрировала книги А. Крученых и входила в орбиту Гилеи: её путь от кубофутуризма к супрематизму – модель всего движения.',
  },
  {
  ...
  },
  {
    ...
    description: 'Лучизм – живописный аналог зауми: изображается не предмет, а лучи, исходящие от него. Восприятие важнее вещи. В тот же год А. Крученых публикует Дыр бул щыл – звуки важнее слов. Обе стратегии атакуют одно и то же.',
  },
  {
