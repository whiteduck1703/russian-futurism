...
export function Comparison() {
  ...
  const columns = [
    { topBorder: '#E05555', tag: 'КУБОФУТУРИЗМ', name: '«ГИЛЕЯ»', years: '1910 &#x2013; 1915', keyFigure: 'Бурлюк · Маяковский · Хлебников · Крученых', tagline: 'Деструкция &#x2013; сломать, чтобы построить заново' },
    { topBorder: '#E8C84A', tag: 'ЭГО-ФУТУРИЗМ', name: '«ЭГО-ФУТУРИСТЫ»', years: '1911 &#x2013; 1914', keyFigure: 'Северянин · Игнатьев · Гнедов', tagline: 'Индивидуализация &#x2013; торжество абсолютного Я' },
    { topBorder: '#50B87A', tag: 'СИНТЕТИЧЕСКИЙ ПУТЬ', name: '«ЦЕНТРИФУГА»', years: '1913 &#x2013; 1917', keyFigure: 'Пастернак · Бобров · Асеев · Божидар', tagline: 'Рефлексия &#x2013; строить, а не разрушать' }
  ];
  ...
  const rows = [
    ...
    },
    {
      label: 'К СЛОВУ',
      values: [
        'Материал для преобразования. Для Крученых &#x2013; расплавить. Для Хлебникова &#x2013; раскрыть тайну. Для Маяковского &#x2013; взрывчатое вещество.',
        'Украшение и палитра. Неологизмы Северянина &#x2013; не разрушение, а расширение: грезэрка, олилиенен, экстазная.',
    ...
    },
    {
      ...
      values: [
        ...
        'Рафинированный эстет. Я, гений Игорь Северянин. Певец электрических, коктейльных, ананасовых радостей. Или &#x2013; радикальное молчание Гнедова.',
    ...
    },
    {
      label: 'К МАРИНЕТТИ',
      values: [
        'Демонстрация возможности &#x2013; не образец. Псевдофутуристами назвал нас Маринетти? Значит, мы &#x2013; подлинно русские. Разрыв после визита 1914 г.',
        'Эклектичное заимствование урбанистической риторики при полном сохранении декадентской эстетики. Ближе к Бодлеру, чем к Маринетти.',
        'Дистанцирование. Маринетти говорил о мире. Мы говорим о слове. Это принципиально разные проекты.'
      ]
    },
    {
      label: 'СУДЬБА ПОСЛЕ 1917',
      values: [
        'Маяковский &#x2013; РОСТА &#x2013; ЛЕФ &#x2013; трагедия. Хлебников умирает в 1922, непризнанным. Крученых на периферии. Бурлюк эмигрирует в США.',
        'Северянин эмигрирует в Эстонию, пишет ностальгические стихи. Гнедов дожил до 1978 &#x2013; и почти ничего не публиковал. Игнатьев погиб в 21 год.',
        'Наиболее долговечное наследие. Пастернак работает до 1960-х. Асеев входит в советскую культуру. Синтез оказывается устойчивее крайности.'
      ]
    }
  ];
