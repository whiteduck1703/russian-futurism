...
export function Comparison() {
  ...
  const columns = [
    { topBorder: '#E05555', tag: 'КУБОФУТУРИЗМ', name: '«ГИЛЕЯ»', years: '1910 &#x2013; 1915', keyFigure: 'Д. Бурлюк · В. Маяковский · В. Хлебников · А. Крученых', tagline: 'Деструкция &#x2013; сломать, чтобы построить заново' },
  ...
  const rows = [
    ...
    },
    {
      label: 'К СЛОВУ',
      values: [
        'Материал для преобразования. Для А. Крученых &#x2013; расплавить. Для Хлебникова &#x2013; раскрыть тайну. Для Маяковского &#x2013; взрывчатое вещество.',
    ...
    },
    {
      ...
      values: [
        ...
        'Рафинированный эстет. Я, гений Игорь И. Северянин. Певец электрических, коктейльных, ананасовых радостей. Или &#x2013; радикальное молчание Гнедова.',
    ...
    },
    {
      ...
      values: [
        'В. Маяковский &#x2013; РОСТА &#x2013; ЛЕФ &#x2013; трагедия. В. Хлебников умирает в 1922, непризнанным. А. Крученых на периферии. Д. Бурлюк эмигрирует в США.',
