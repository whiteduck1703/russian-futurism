...
export function Quiz() {
  ...
  const questions = [
    ...
    {
      question: 'Твои отношения с Ф. Маринетти?',
      options: [
        ...
        { text: 'Ф. Маринетти говорит о мире, мы – о слове. Принципиально разные проекты.', group: 'centrifuga' }
      ]
    },
    {
  ...
  const results = {
    gileya: {
      title: 'Ты – Гилеец!',
      text: 'Тебе близок радикальный разрыв, коллективный бунт и слово как взрывчатое вещество. Твои ориентиры – В. Маяковский, В. Хлебников, А. Крученых. Стадия деструкции: сломать, чтобы построить заново.',
      color: '#E05555'
    },
    ego: {
      title: 'Ты – Эго-футурист!',
      text: 'Абсолютное «Я», изысканность и эстетизация современного быта. Твой ориентир – И. Северянин с его «поэзами» и «громокипящим кубком». Или – В. Гнедов с его радикальным молчанием.',
      color: '#E8C84A'
    },
    centrifuga: {
      title: 'Ты – Центрифугист!',
      text: 'Синтез и рефлексия. Слово – живой организм. Поэт – свидетель, а не пророк. Твои ориентиры – Б. Пастернак, С. Бобров, Н. Асеев. Стадия, в которой синтез оказывается устойчивее крайности.',
      color: '#50B87A'
    }
  };
