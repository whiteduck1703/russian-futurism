...
const terms = [
  {
    ...
    group: 'Гилея',
    color: '#E05555',
    definition: 'Поэтический язык, освобождённый от конвенционального смысла: слово существует ради звука и ритма, а не словарного значения. Придуман Алексеем А. Крученых в 1913 году.',
    example: '«Дыр бул щыл убешщур» – ни одного общеупотребительного слова, но текст имеет ритмическую и фонетическую структуру. А. Крученых настаивал, что этот текст «по-русски».',
  ...
  },
  {
    ...
    example: '«Лилия красива, но слово «лилия» захватано. Поэтому я называю лилию «ьь» – и первоначальная чистота восстановлена» – А. Крученых.',
  ...
  },
  {
    ...
    example: '«Я, гений Игорь И. Северянин, своей победой упоён!» – манифест в одной строке. Абсолютное «Я» – не поза, а программа.',
  ...
  },
  {
    ...
    example: 'И. Игнатьев писал о «трансментальной интуиции» как основе творчества – противопоставляя её как гилейскому коллективному бунту, так и символистской рефлексии.',
  ...
  },
  {
    ...
    example: '«Февраль. Достать чернил и плакать! / Пока грохочущая слякоть / весною чёрною горит» – Б. Пастернак. «Грохочущая слякоть» – сдвиг: слякоть не должна грохотать.',
  ...
  },
  {
    ...
    group: 'Центрифуга',
    color: '#50B87A',
    definition: 'Ключевой термин С. Боброва: слово развивается по собственным законам, независимо от воли автора. Поэт открывает эти законы, а не изобретает их. «Слагаются стихи навзрыд» – не метафора, а описание метода.',
    example: 'Б. Пастернак описывал творческий процесс как нечто, происходящее помимо сознания: «Я их не пишу – они сами пишутся». Это и есть «внутреннее склонение».',
  ...
  },
  {
    ...
    definition: 'Устные выступления на вечерах – важнейший формат авангарда. В. Маяковский читал стихи стоя, на трибуне. И. Северянин устраивал «поэзоконцерты» с музыкальным сопровождением. В. Гнедов «читал» «Поэму конца» жестом без слов.',
  ...
  },
  {
    ...
    example: '«Жёлтая кофта» В. Маяковского, нарисованные деревянные ложки в петлицах Д. Бурлюка, расписанные лица – всё это работало как реклама задолго до соответствующих маркетинговых теорий.',
  ...
  },
  {
    ...
    example: 'В. Маяковский: «Горе стране, не имеющей своих будетлян! Горе армии, у которой нет разведчиков!» – авангард как буквальная разведка будущего.',
  ...
  },
  {
    ...
    group: 'После 1917',
    color: '#50B87A',
    definition: 'Объединение, основанное В. Маяковским в 1922 году. Наследник кубофутуризма в советских условиях: искусство как инструмент революции, производственничество, документальность. Существовал до 1929 года.',
    example: 'ЛЕФ издавал одноимённый журнал (1923–1925) и «Новый ЛЕФ» (1927–1928). Среди участников – Брик, Родченко, Кирсанов. В. Маяковский закрыл организацию сам, разочаровавшись в ней.',
  ...
  },
  {
    ...
    group: 'Эго-футуризм',
    color: '#E8C84A',
    definition: 'Жанр, придуманный И. Северяниным: поэтический вечер с музыкальным сопровождением, где стихи подаются как романсы или оперные арии. Противоположность гилейским «докладчествам» – не агрессия, а соблазн.',
    example: 'И. Северянин читал стихи нараспев, с закрытыми глазами, в образе томного гения. Его аудитория приходила не анализировать – переживать. Это изобретение поп-концерта avant la lettre.',
  ...
  },
  {
    ...
    example: 'Картины Ларионова в технике лучизма (1912–1913) – цветные штрихи, пересекающие холст без видимого предмета. Современники не понимали их – как и зауми А. Крученых.',
  ...
  },
  {
    ...
    example: 'Гончарова иллюстрировала «Мирскóнца» и «Игру в аду» В. Хлебникова и А. Крученых. Её народные образы и хлебниковская архаическая лексика образовывали единое высказывание.',
  ...
  },
  {
    ...
    group: 'Центрифуга',
    color: '#50B87A',
    definition: 'Термин, использованный Б. Пастернаком: поэтический текст – это всегда «оговорка» относительно того, что хотел сказать поэт. Поэзия выражает то, что не вмещается в прямое высказывание.',
    example: '«Февраль. Достать чернил и плакать!» – это не то, что Б. Пастернак «хотел сказать», а то, что сказалось вопреки намерению. Оговорка честнее речи.',
