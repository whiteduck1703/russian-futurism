...
const terms = [
  {
    ...
    group: 'Гилея',
    color: '#E05555',
    definition: 'Поэтический язык, освобождённый от конвенционального смысла: слово существует ради звука и ритма, а не словарного значения. Придуман А. Кручёных в 1913 году.',
    example: '«Дыр бул щыл убешщур» – ни одного общеупотребительного слова, но текст имеет ритмическую и фонетическую структуру. А. Кручёных настаивал, что этот текст «по-русски».',
  ...
  },
  {
    ...
    example: '«Лилия красива, но слово «лилия» захватано. Поэтому я называю лилию «ьь» – и первоначальная чистота восстановлена» – А. Кручёных.',
  ...
  },
  {
    ...
    example: 'Картины Ларионова в технике лучизма (1912–1913) – цветные штрихи, пересекающие холст без видимого предмета. Современники не понимали их – как и зауми А. Кручёных.',
  ...
  },
  {
    ...
    example: 'Гончарова иллюстрировала «Мирскóнца» и «Игру в аду» В. Хлебникова и А. Кручёных. Её народные образы и хлебниковская архаическая лексика образовывали единое высказывание.',
