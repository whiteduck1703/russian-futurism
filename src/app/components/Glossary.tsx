...
const terms = [
  {
    ...
    group: 'Гилея',
    color: '#E05555',
    definition: 'Поэтический язык, освобождённый от конвенционального смысла: слово существует ради звука и ритма, а не словарного значения. Придуман А. Крученых в 1913 году.',
