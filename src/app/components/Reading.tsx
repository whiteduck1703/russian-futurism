...
const editions = [
  ...
  },
  {
    ...
    author: 'Бурлюк, Кручёных, Маяковский, Хлебников',
    year: '1912',
    group: 'Кубофутуризм',
    color: '#E05555',
  ...
  {
    title: 'Трое',
    author: 'Хлебников, Кручёных, Гуро',
    year: '1913',
    group: 'Кубофутуризм',
    color: '#E05555',
  ...
  {
    title: 'Игра в аду',
    author: 'Алексей Кручёных, Велимир Хлебников',
    year: '1912',
    group: 'Кубофутуризм',
    color: '#E05555',
    cover: '/images/covers/igra_v_adu.jpg',
    note: 'Поэма, написанная совместно Кручёных и Хлебниковым. Одно из первых изданий группы «Гилея». Соединение фольклорных и богоборческих мотивов.',
    availability: 'Скан &#x2013; Национальная электронная библиотека',
    url: 'https://rusneb.ru/catalog/000200_000018_rc_1924557/'
  },
  {
    title: 'Заумная книга',
    author: 'Кручёных, Алягров (Якобсон)',
    year: '1915',
    group: 'Заумь',
  ...
  },
  {
    ...
    author: 'Кручёных, Розанова',
    year: '1914',
    group: 'Заумь',
    color: 'var(--c-text-muted)',
    cover: '/images/covers/utinoe_gnezdo.jpg',
    note: 'Книга-объект, где текст и изображение неразделимы. Ольга Розанова создала цветные коллажи, Кручёных &#x2013; зауминые тексты. Один из лучших примеров книги как тотального произведения.',
...
const onlineResources = [
  ...
  },
  {
    ...
    url: 'https://az.lib.ru',
    color: '#50B87A',
    description: 'Один из старейших и крупнейших русскоязычных текстовых архивов. Раздел «Антология» содержит тексты Хлебникова, Кручёных, Северянина, Маяковского, Шкловского, Якобсона и других участников движения. Бесплатный доступ без регистрации.',
    tag: 'Тексты'
  },
  {
  ...
  },
  {
    ...
    color: 'var(--c-text-muted)',
    description: 'Русскоязычный раздел Викитеки содержит полные тексты Маяковского, Хлебникова, Северянина, Кручёных и других поэтов авангарда. Свободный доступ, верифицированные тексты.',
    tag: 'Тексты'
  },
];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {research.map((book, i) => (
              <div key={i} className="p-6 rounded-lg" style={{ backgroundColor: 'var(--c-bg)' }}>
                ...
                <p className="text-[14px] leading-[1.7] mb-3" style={{ fontFamily: 'var(--font-body)', color: 'var(--c-text)' }}
                  dangerouslySetInnerHTML={{ __html: book.note }}
                />
                <div className="pt-3" style={{ borderTop: '2px solid #1E1E52' }}>
                  {book.url ? (
