...
const editions = [
  ...
  },
  {
    ...
    note: 'Второй альманах — более зрелый. «Заклятие смехом» Хлебникова, ранний Маяковский, манифест группы. Нестандартный формат, обёрточная бумага.',
    availability: 'Скан — Национальная электронная библиотека',
  ...
  },
  {
    ...
    note: 'Первый и самый знаменитый сборник Северянина, выдержавший 10 изданий при жизни автора. «Я, гений Игорь Северянин, своей победой упоён» — не ирония, а манифест.',
  ...
  },
  {
    ...
    note: 'Книга-объект, где текст и изображение неразделимы. Ольга Розанова создала цветные коллажи, Крученых — заумные тексты. Один из лучших примеров книги как тотального произведения.',
    availability: 'Скан — Национальная электронная библиотека',
  ...
  },
  {
    ...
    url: 'https://ru.wikisource.org/wiki/Облако_в_штанах_(Маяковский)',
  },
  {
    ...
    availability: 'Полный текст — Викитека',
    url: 'https://ru.wikisource.org/wiki/Ананасы_в_шампанском_(Северянин)',
  },
  {
    title: 'Заумная книга',
  ...
  },
  {
    ...
    availability: 'Полный текст — Викитека',
    url: 'https://ru.wikisource.org/wiki/Зангези_(Хлебников)',
  },
  {
    title: 'Для голоса',
    author: 'Владимир Маяковский',
