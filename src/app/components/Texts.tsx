...
const editions = [
  {
    ...
    note: 'Первый кубофутуристический альманах, напечатанный на обороте обоев – не из экономии, а как художественный жест. Вошли стихи Хлебникова, Каменского, Бурлюка.',
  ...
  {
    title: 'Игра в аду',
    author: 'Алексей А. Крученых, Велимир В. Хлебников',
    year: '1912',
    group: 'Кубофутуризм',
    color: '#E05555',
    cover: '/images/covers/igra_v_adu.jpg',
    note: 'Поэма, написанная совместно А. Крученых и Хлебниковым. Одно из первых изданий группы «Гилея». Соединение фольклорных и богоборческих мотивов.',
    availability: 'Скан – Национальная электронная библиотека',
  ...
  },
  {
    ...
    note: 'Второй альманах – более зрелый. «Заклятие смехом» Хлебникова, ранний В. Маяковский, манифест группы. Нестандартный формат, обёрточная бумага.',
    availability: 'Скан – Национальная электронная библиотека',
    url: 'https://rusneb.ru/catalog/000200_000018_rc_1884059/',
  },
  {
    title: 'Трое',
    author: 'В. Хлебников, А. Крученых, Гуро',
    year: '1913',
    group: 'Кубофутуризм',
    color: '#E05555',
  ...
  },
  {
    ...
    note: 'Первый и самый знаменитый сборник Северянина, выдержавший 10 изданий при жизни автора. «Я, гений Игорь И. Северянин, своей победой упоён» – не ирония, а манифест.',
  ...
  },
  {
    ...
    note: 'Первый сборник Маяковского – четыре стихотворения, тираж 300 экземпляров. Обложка нарисована Давидом Бурлюком. Редчайший первоисточник.',
    availability: 'Скан – Национальная электронная библиотека',
    url: 'https://rusneb.ru/catalog/000199_000009_003805966/',
  },
  {
    title: 'Утиное гнёздышко',
    author: 'А. Крученых, Розанова',
    year: '1914',
    group: 'Заумь',
    color: 'var(--c-text-muted)',
    cover: '/images/covers/utinoe_gnezdo.jpg',
    note: 'Книга-объект, где текст и изображение неразделимы. Ольга Розанова создала цветные коллажи, А. Крученых – заумные тексты. Один из лучших примеров книги как тотального произведения.',
    availability: 'Скан – Национальная электронная библиотека',
  ...
  },
  {
    ...
    note: 'Тетраптих – четыре части, четыре «долой»: вашу любовь, ваше искусство, ваш строй, вашу религию. Лучшее из написанного Маяковским как лириком.',
  ...
  {
    title: 'Заумная книга',
    author: 'А. Крученых, Алягров (Якобсон)',
    year: '1915',
    group: 'Заумь',
    color: 'var(--c-text-muted)',
