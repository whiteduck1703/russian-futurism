...
const editions = [
  ...
  },
  {
    ...
    note: 'Поэма, написанная совместно А. Кручёных и Хлебниковым. Одно из первых изданий группы «Гилея». Соединение фольклорных и богоборческих мотивов.',
    availability: 'Скан – Национальная электронная библиотека',
  ...
  {
    title: 'Трое',
    author: 'В. Хлебников, А. Кручёных, Гуро',
    year: '1913',
    group: 'Кубофутуризм',
    color: '#E05555',
